...
import br.com.totvs.bills_manager.adapter.in.rest.request.LoginRequestMock;
import br.com.totvs.bills_manager.adapter.in.rest.request.RegisterRequestMock;
...
class AuthenticationControllerTest {
    ...
    void shouldReturnsLoginSuccessfullyLogin(){
        ...
        ResponseEntity<LoginResponse> response = authenticationController.login(LoginRequestMock.create(login, password));
